	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			{//change here
				...
				request.setAttribute("finalbillmessage","Your Bill Amount is : $" + finalbill + " ! Thank you for Shopping with us!");
				request.setAttribute("purchasemsg","You Purchased the following items");
